...
//********************************************************************************************
	...
	var createUI = function()
	{
		...
		var Dpi = winObj.add("panel", [28,73,28+361,73+54], "Dpi(基本的に72dpiしか使わない事。イラレ基準)");
		...
		{
			pref.cross = cbCross.value;
			pref.paint = cbPaint.value;
			...
			createFrame(xp,yp,dpi,pref.cross,pref.paint);
		}
