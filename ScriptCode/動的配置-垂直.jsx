(function (me){
 ...
 // 環境設定ファイルのFileオブジェクトを返す
	...
	var moveObject = function(mv,mode)
	{
		...
		var minY= -selObj[0].top + selObj[0].height/2;
		var maxY= -selObj[selObj.length-1].top + selObj[selObj.length-1].height/2;

		var srcLen = maxY - minY;
	...
	var createDialog = function()
	{
		...
		y0=0;
		var cba =[];
		cba.push(ganchor.add("radiobutton",[x0,y0,x0+80,y0+25],"上合わせ"));
		x0 +=90;
		cba.push(ganchor.add("radiobutton",[x0,y0,x0+80,y0+25],"中央合わせ"));
		x0 +=90;
		cba.push(ganchor.add("radiobutton",[x0,y0,x0+80,y0+25],"下合わせ"));
		x0 +=90;
